...
const listValue = (object, index) => {
  let position = Object.values(object)[index];
  return position;
}
console.log(listValue(lesson1, 2));

//Crie uma função que verifique se o par (chave / valor) existe na função. Essa função deve possuir três parâmetros, sendo eles: o objeto, o nome da chave e o valor da chave

const verifyEntry = (object, key, value) => {
  if (object[key] === value) return true; else return false;
}

console.log(verifyEntry(lesson1, 'materia', 'Matemática'));
